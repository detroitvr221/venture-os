    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0a0a0a] px-4">
      <div className="text-center">
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          <button onClick={() => reset()} className="rounded-lg bg-gradient-to-r from-[#3b82f6] to-[#8b5cf6] px-6 py-2.5 text-sm font-medium text-white transition hover:opacity-90">
            Try Again
          </button>
